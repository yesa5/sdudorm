...
@section('content')
    ...
    <!-- banner -->
    <div class="banner">
        <img src="{{asset('images/banner.jpg')}}"  class="img-responsive" alt="slide">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-7 col-md-8">
                    <div class="embed-responsive embed-responsive-16by9 wowload fadeInLeft"><iframe  class="embed-responsive-item" src="https://www.youtube.com/watch?v=pDqsQ7dXzAI" width="100%" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
                </div>
